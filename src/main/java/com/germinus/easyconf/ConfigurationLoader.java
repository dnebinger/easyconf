...
class ConfigurationLoader {
	...
	/**
	 * createAggregatedProperties: Utility method to create an aggregated properties instance.
	 * 
	 * @param companyId
	 * @param componentName
	 * @return AggregatedProperties The instance to use.
	 */
	protected AggregatedProperties createAggregatedProperties(final String companyId, final String componentName) {
		return new AggregatedProperties(companyId, componentName);
	}

    public ComponentProperties readPropertiesConfiguration(String companyId, String componentName) {
		AggregatedProperties properties = createAggregatedProperties(companyId, componentName);
//        if (companyId != null) {
