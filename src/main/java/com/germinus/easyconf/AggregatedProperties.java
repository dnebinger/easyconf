...
public class AggregatedProperties extends CompositeConfiguration {
	...
	/**
	 * createPropertiesConfiguration: Responsible for creating the properties configuration object for the given filename. Subclasses can override this method to have alternate implementations.
	 * 
	 * @param fileName Name of the file to build a properties configuration for.
	 * @return PropertiesConfiguration The new properties configuration instance.
	 * @throws org.apache.commons.configuration.ConfigurationException
	 */
	protected PropertiesConfiguration createPropertiesConfiguration(final String fileName) throws org.apache.commons.configuration.ConfigurationException {
	...
	private Configuration addFileProperties(String fileName,
		...
		try {
			FileConfiguration newConf = createPropertiesConfiguration(fileName);
