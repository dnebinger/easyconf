...
public class ComponentProperties {
	...
	private AggregatedProperties properties;

	public ComponentProperties(final AggregatedProperties conf) {
		this.properties = conf;
		setThrowExceptionOnMissing(false);
	}

	protected AggregatedProperties getAggregatedProperties() {
		return properties;
	}

	protected void setAggregatedProperties(final AggregatedProperties conf) {
		properties = conf;
	}
